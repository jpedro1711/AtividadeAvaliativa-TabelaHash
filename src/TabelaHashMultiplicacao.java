public class TabelaHashMultiplicacao {
    ...
    public TabelaHashMultiplicacao(Integer tamanho) {
        this.tamanho = tamanho;
        dados = new ListaEncadeada[tamanho];
    }

    public void inserir(Registro registro) {
        int posicao = funcaoHashComMultiplicacao(registro.getCodigoRegistro());
    ...
    public Registro buscar(int cod, int valor) {
        int posicao = funcaoHashComMultiplicacao(cod);
        if (dados[posicao] != null) {
